...
def generate_excel_file(wd, destination_folder, filetype_to_model, security_policy):
    ...
    excel_result_path = wd.joinpath(r"data\Excel Files\AMPIngestFile.xlsx")
    ...
    try:
        ...
        excel_result_path = Path.home() / 'AMPIngest/AMPIngestFile.xlsx'
    ...
    for root, dirs, files in os.walk(destination_folder):
        for i in files:
            ...
            metadata_model_cell.font = main_font
            file_path_cell.font = main_font
            security_cell.font = main_font
            folder_cell.font = main_font
